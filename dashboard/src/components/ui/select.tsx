...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-8 w-full items-center justify-between gap-2 rounded-md border bg-background/40 px-2.5 py-1 text-sm shadow-sm cursor-pointer',
      'focus:outline-none focus:ring-2 focus:ring-ring/60 disabled:opacity-50 [&>span]:truncate',
      className,
    )}
    {...props}
  >
