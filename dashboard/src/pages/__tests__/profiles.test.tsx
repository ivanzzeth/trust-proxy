...
function mockPolicy() {
  ...
  vi.spyOn(api, 'directlist').mockResolvedValue({ domains: ['cn.com'], ips: [], builtin: [], private_direct: true, notes: {} });
  ...
  vi.spyOn(api, 'proxyGroups').mockResolvedValue({ auto_country: true, exclude_countries: [], groups: [], failover: { interrupt_existing_connections: false }, scoring: {} });
