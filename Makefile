...
e2e-dataplane:
	go test -count=1 -tags docker_e2e -run 'TestLinux(DefaultDeny|GlobalMode|GuardedMode|PolicySurvives|LoginRotates|FreshInstallResolves|UpgradeHealsTheOldDNS|SplitWorksWithNo|PostureSwitchKeeps)' -v -timeout 20m ./test/
