...
func routeLevels() map[string]access {
	return map[string]access{
		...
		"GET /api/node-overrides":          accessAdmin,
		"PUT /api/node-overrides":          accessAdmin,
		"PATCH /api/node-overrides":        accessAdmin,
		"POST /api/nodes/disable":          accessAdmin,
		"POST /api/nodes/enable":           accessAdmin,
