...
internal/tuncfg/           TUN 高级选项（stack/mtu/strict_route/**auto_redirect**/address/exclude·include_package，applyMode 用；Linux 默认 auto_redirect 捕获 Docker/containerd bridge 出网；TUN 地址默认 `198.18.0.1/30` 避开 172.16/12）
